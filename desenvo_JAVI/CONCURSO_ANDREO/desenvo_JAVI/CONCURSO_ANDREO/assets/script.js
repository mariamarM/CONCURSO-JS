...
function finalizarJuego() {
  ...
  localStorage.setItem('acertadasFinales', valor);
    localStorage.setItem('puntosFinales', valor);
  localStorage.setItem('falladasFinales', valor);
getItem('acertadasFinales').innerText.display = 'block';
getItem()
